...
int main( int argc, char * argv[] )
{
    ...
    if ( numArrayComponents > 1 ) {
        FTL_VERIFY( numArrayComponents == 3 ); // hack for ease of implementation below
    ...
    const std::string outFileName = corlib::UniqueFilename(1)( dataName, datumComponent, "dat" );
    ...
    out << "# Generated by " << argv[0] << "  " << argv[1] << std::endl
        ...
        << (datumComponent < numArrayComponents ? 
                             corlib::UniqueFilename::convertNumberToString(datumComponent,1) 
                             : "" ) 
