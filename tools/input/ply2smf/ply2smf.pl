...
# ABOUT
# Takes Stanford PLY ascii/binary file, and converts it to a SMF file
#
# USAGE
# ./ply2smf.pl < infile.ply > outfile.smf
#
# NOTES
# File was adapted from
# http://www.cs.jhu.edu/~misha/Code/PoissonRecon/ply2mesh.pl
# PLY docu at
