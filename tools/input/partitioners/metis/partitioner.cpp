...
#include <tools/input/partitioners/metis/PartitionerMetis.hpp>
#include <tools/input/partitioners/utils/misc.hpp>

//==============================================================================
/** \brief Partitioner of a mesh using METIS 
*  \details This program calls functions of Partitioner METIS to create partition of mesh into
*  subdomains based on dual graph of the mesh. It can run in two distinct modes:
...
*
*    The code was developed and tested with METIS v4.0 and v5.0. 
*/
int main( int argc, char * argv[] )
{
    ...
    partitioners::metis::PartitionerMetis partitioner( numNodes, numElements, 
                                                       eleShape, numNodesPerElement );
    ...
    // partition the mesh by METIS
    partitioner.createPartition( elements, numSub, overlapLayers );
