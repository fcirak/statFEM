...
clean:
	...
	rm -f planeSheetRCB/planeSheet.000-0020.vtu
	rm -f planeSheetRCB/planeSheet.001-0020.vtu
	rm -f planeSheetRCB/planeSheet.002-0020.vtu
	rm -f planeSheetRCB/planeSheet.003-0020.vtu
...
run:
	bash -c "${SOURCE_MY_ENV} && cd planeSheetRCB && mpirun -np 4 ../parallelDriven && cd .."
	@echo "WatchDog run successful"

test:
	$(VTUDIFF) --new=planeSheetRCB/planeSheet.000-0020.vtu --ref=planeSheetRCB/watchDog.0.planeSheet.000-0020.vtu --comp=rel --tol=1.e-5
	$(VTUDIFF) --new=planeSheetRCB/planeSheet.001-0020.vtu --ref=planeSheetRCB/watchDog.0.planeSheet.001-0020.vtu --comp=rel --tol=1.e-5
	$(VTUDIFF) --new=planeSheetRCB/planeSheet.002-0020.vtu --ref=planeSheetRCB/watchDog.0.planeSheet.002-0020.vtu --comp=rel --tol=1.e-5
	$(VTUDIFF) --new=planeSheetRCB/planeSheet.003-0020.vtu --ref=planeSheetRCB/watchDog.0.planeSheet.003-0020.vtu --comp=rel --tol=1.e-5
