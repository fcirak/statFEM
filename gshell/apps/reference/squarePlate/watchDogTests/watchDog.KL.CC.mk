...
build:
	cd .. && make -f Makefile DEBUG=NO KINEM=KIRCHHOFFLOVE SHAPEFUN=CATMULL_CLARK MESH=CC
...
test:
	$(VTUDIFF) --new=../animation/meshCC.0001.vtu --ref=watchDog.KL.CC.meshCC.0001.vtu --tol=1.e-6
