...
build:
	cd .. && make -f Makefile DEBUG=NO KINEM=SHEARFLEXIBLE SHAPEFUN=LOOP MESH=B
...
test:
	$(VTUDIFF) --new=../animation/meshLoopB.0001.vtu --ref=watchDog.SF.LoopB.meshLoopB.0001.vtu --tol=1.e-6
