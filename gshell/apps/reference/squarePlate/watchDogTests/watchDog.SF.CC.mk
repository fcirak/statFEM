...
build:
	cd .. && make -f Makefile DEBUG=NO KINEM=SHEARFLEXIBLE SHAPEFUN=CATMULL_CLARK MESH=CC
...
test:
	$(VTUDIFF) --new=../animation/meshCC.0001.vtu --ref=watchDog.SF.CC.meshCC.0001.vtu --tol=1.e-6
