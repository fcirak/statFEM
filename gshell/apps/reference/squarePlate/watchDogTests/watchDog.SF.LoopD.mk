...
build:
	cd .. && make -f Makefile DEBUG=NO KINEM=SHEARFLEXIBLE SHAPEFUN=LOOP MESH=D
...
test:
	$(VTUDIFF) --new=../animation/meshLoopD.0001.vtu --ref=watchDog.SF.LoopD.meshLoopD.0001.vtu --tol=1.e-6
