...
build:
	cd .. && make -f Makefile DEBUG=NO KINEM=KIRCHHOFFLOVE SHAPEFUN=LOOP MESH=A
...
test:
	$(VTUDIFF) --new=../animation/meshLoopA.0001.vtu --ref=watchDog.KL.LoopA.meshLoopA.0001.vtu --tol=1.e-6
